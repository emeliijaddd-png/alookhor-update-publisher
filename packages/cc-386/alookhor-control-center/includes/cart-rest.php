...
function alookhor_cc_cart_bootstrap() {
    ...
    /* ── 3.10.420: ریشهٔ زندهٔ «هر درخواست = سشن خالی» — روی لایو پاسخ‌های REST
...
add_action('rest_api_init', function () {
    ...
    register_rest_route('alookhor-cart/v4', '/cart/add', [
        ...
        'callback' => function (WP_REST_Request $request) {
            ...
            /* ── 3.10.420: اگر variation_id آمد ولی نقشهٔ ویژگی خالی بود (مثل دکمهٔ «افزودن»
    ...
    /* ── 3.10.420: اندپوینت تشخیص موقت — برای یافتنِ علت «محصول در سبد پیدا نشد» روی لایو
