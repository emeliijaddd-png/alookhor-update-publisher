...
define('ALOOKHOR_CC_VERSION', '3.10.417');
define('ALOOKHOR_CC_BUILD', '3.10.417');
...
require_once ALOOKHOR_CC_DIR . 'includes/hero-banners.php';
...
require_once ALOOKHOR_CC_DIR . 'includes/cart-probe.php';
require_once ALOOKHOR_CC_DIR . 'includes/commerce-cache-shield.php';
