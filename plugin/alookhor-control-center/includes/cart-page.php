...
<div id="alookhor-cart" dir="rtl">
  <div id="alookhor-cart-nonce" style="display:none"><?php echo wp_create_nonce("wc_store_api"); ?></div>
  <div class="cart-error" style="display:none;background:#3a1a1a;border:1px solid #e42a68;color:#fff;padding:12px;border-radius:8px;margin-bottom:16px"></div>
  <div class="cart-hero">
