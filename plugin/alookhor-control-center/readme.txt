...
= 3.10.73 =
* منوی اصلی شیشه‌ای با کلید فعال/غیرفعال، درصد شفافیت و شدت Blur از داخل مدیریت بوتیک
* چهارده کنترل رنگ برای تمام اجزای هدر، کپسول منو و مگامنو؛ ذخیره امن و اعمال مستقیم روی سایت
