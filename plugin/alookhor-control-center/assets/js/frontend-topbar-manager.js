/**
 * ALOOKHOR Legacy Top Bar Manager — v3.9.0
...
(() => {
  ...
  function manage(root, force = false) {
    if (!root || (!force && root.dataset.topbarManaged === '3.9.0')) return;
    ...
    root.dataset.topbarManaged = '3.9.0';
    root.dispatchEvent(new CustomEvent('alookhor:topbar-managed', {bubbles:true, detail:{version:'3.9.0'}}));
  }
