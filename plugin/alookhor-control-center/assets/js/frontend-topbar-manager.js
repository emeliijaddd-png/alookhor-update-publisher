/**
 * ALOOKHOR Legacy Top Bar Manager — v3.9.1
...
(() => {
  ...
  function manage(root, force = false) {
    if (!root || (!force && root.dataset.topbarManaged === '3.9.1')) return;
    ...
    root.dataset.topbarManaged = '3.9.1';
    root.dispatchEvent(new CustomEvent('alookhor:topbar-managed', {bubbles:true, detail:{version:'3.9.1'}}));
  }
