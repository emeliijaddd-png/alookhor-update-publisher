...
const runtimeVersion = String(runtimeConfig.version || '3.10.160');
...
export const Updater = {
  ...
  lastCheck: null,
  changelog: [
    { tag: 'SORT CENTER V2', title: 'v3.10.160 — مرکز سورت لوکس', desc: 'اسلایدر، Glass، آمار، دو CTA و Mobile UX کامل اجرا شد.' },
    ...
    { tag: 'WHY CLEANUP', title: 'v3.10.160 — اصلاح متن و نقاط موبایل', desc: 'توضیح دسکتاپ تک‌خطی و نقاط تزئینی موبایل حذف شدند.' },
