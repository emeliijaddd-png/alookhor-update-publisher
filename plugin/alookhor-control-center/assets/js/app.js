...
import { initResponsive } from './core/responsive.js?v=3.10.2';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.2';
import { Config } from './core/config.js?v=3.10.2';
import { dashboardModule } from './modules/dashboard.js?v=3.10.2';
import { inventoryModule } from './modules/inventory.js?v=3.10.2';
import { ordersModule } from './modules/orders.js?v=3.10.2';
import { usersModule } from './modules/users.js?v=3.10.2';
import { analyticsModule } from './modules/analytics.js?v=3.10.2';
import { settingsModule } from './modules/settings.js?v=3.10.2';
