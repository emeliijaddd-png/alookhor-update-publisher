...
import { initResponsive } from './core/responsive.js?v=3.8.9';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.8.9';
import { Config } from './core/config.js?v=3.8.9';
import { dashboardModule } from './modules/dashboard.js?v=3.8.9';
import { inventoryModule } from './modules/inventory.js?v=3.8.9';
import { ordersModule } from './modules/orders.js?v=3.8.9';
import { usersModule } from './modules/users.js?v=3.8.9';
import { analyticsModule } from './modules/analytics.js?v=3.8.9';
import { settingsModule } from './modules/settings.js?v=3.8.9';
