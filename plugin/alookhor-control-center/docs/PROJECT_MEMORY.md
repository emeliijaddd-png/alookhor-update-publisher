...
- **Production پیش از این Release:** `3.10.7` (Search/ردیف اضافه حذف و Mobile مطابق مرجع)
- **Release آماده انتشار اتمی:** `3.10.8` (حذف Offset زنده، Sticky قطعی Desktop و مهار لوگو)
