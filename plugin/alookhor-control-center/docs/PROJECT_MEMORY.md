...
- **Production پیش از این Release:** `3.10.8` (Offset حذف، Sticky و Geometry در Chrome تأیید شد)
- **Release آماده انتشار اتمی:** `3.10.9` (تطبیق بصری نهایی کپسول و Top Bar Mobile با مرجع)
