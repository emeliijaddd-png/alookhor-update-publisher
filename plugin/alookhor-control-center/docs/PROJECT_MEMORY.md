...
- **Working tree (پیش‌نویس توسعه):** `3.10.20` — ماژول قاب خرید لوکس صفحه تکی محصول (`[alookhor_buybox]` + Takeover خودکار) مطابق مرجع تصویری مالک؛ پس از تأیید مالک، Tag/Release مستقل لازم دارد.
