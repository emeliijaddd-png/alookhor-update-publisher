...
- CAPSULE: شفافیت و Blur فقط روی خود کپسول گرد منو اعمال می‌شود؛ حالت Sticky نیز بیرون کپسول هیچ زمینه‌ای ندارد.
- ADMIN: متن کنترل‌های بوتیک دقیق شد تا مشخص باشد تنظیمات شیشه مربوط به کپسول است.
