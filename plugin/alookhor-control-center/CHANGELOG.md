## 3.10.267 — MOBILE PDP EXACT PER 2 MOCKUPS — media-query only، دسکتاپ بدون حتی یک پیکسل تغییر
...
- CSS v3.10.267 MOCKUP PDP — بدون CJK، بدون تغییر نام/حذف فایل، حفظ همه فیکس‌های ۲۴۶ تا ۲۶۱
