...
## v3.8.7 — DRAFT — Top Bar Persistence & Activation-State Recovery
...
- RELEASE: این نسخه Draft است؛ تا تکمیل Bridge انتقال 3.8.6 → 3.8.7 نباید Tag یا Production Release ساخته شود.
