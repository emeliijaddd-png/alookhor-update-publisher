## 3.10.353 — باکس قیمت صفحهٔ محصول طبق دستور مالک (قیمت اصلی بزرگ‌تر و سفید، قیمت تخفیف‌خورده بزرگ‌تر، هر دو در ردیف بالا)
- قیمت خط‌خوردهٔ اصلی: ۱۸px، سفید، خط قرمز؛ قیمت تخفیف‌خورده: تا ۳۲px طلایی (در ۱۲۸۰px حدود ۲۷px تا چهار آیتم در یک ردیف جا شوند)؛ هر دو به ردیف بالا کنار «قیمت محصول:» منتقل شدند (برچسب راست ← قیمت اصلی ← قیمت جدید ← نشان تخفیف چپ).
- هیچ چیز دیگری در باکس تغییر نکرد: پس‌زمینه، حاشیه، گردی، پدینگ، نشان صورتی تخفیف و برچسب همان قبلی‌اند. تکنیک: دو wrapper داخلی `display:contents` شدند؛ بدون تغییر markup؛ JS تعویض وزن همان دو span را به‌روز می‌کند (تست شد: هر سه چیپ).
- باکس کوتاه‌تر شد (۱۱۸ → ۶۵px در ۱۴۴۰)؛ باکس وزن، تعداد و دکمهٔ سبد ۵۱px بالاتر می‌آیند؛ بقیهٔ صفحه بدون تغییر.
- موبایل ≤640px: خط اول برچسب + نشان تخفیف (مثل قبل)، خط دوم قیمت اصلی سفید ۱۶px + قیمت جدید ۲۸px، ۴px بالاتر از قبل. تبلت مثل دسکتاپ تک‌ردیفی.
- پایه: 3.10.352 سشن سبد (سبز؛ شامل کارت «درباره» ۳۵۰، self-heal seeder و پولیش موبایل ۳۲۳).
