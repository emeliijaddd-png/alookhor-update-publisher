...
- **Plugin/source version:** `3.10.124`
...
- CURRENT VERSION: `3.10.124`
- LAST FUNCTIONAL CHANGE: تلاش سوم انتشار Rich Plum پس از اختلال DNS داخلی سرور WordPress.
...
CURRENT VERSION: 3.10.124
CHANGE: تلاش سوم انتشار Rich Plum پس از اختلال DNS داخلی سرور WordPress.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.124 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.124 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.124 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.124 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.124 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.124 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.124 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.124 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.124 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.124 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.124 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.124 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.124 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.124 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.124 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.124 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.124 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.124 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.124 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.124 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.124 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.124 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.124 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.124 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.124 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.124 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.124 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 413 | `234b1a15c5a9d2e109cf390a12030ef972e357d72f8926e1c402664b2efcc80b` |
...
| `plugin/alookhor-control-center/assets/css/frontend-bestsellers.css` | 24 | `102e7f30936f5c79a2d0e017c8b28af00e77d627a2f7bb019e53edb0ed2d5d22` |
...
| `plugin/alookhor-control-center/assets/css/frontend-design-system.css` | 76 | `f82b01977fd5e8501bf6b587233808e11834b42e20e7bf26c1592ebbaf846cec` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `2072fc03fb86f0df47e3289253daa83ee6175c0d5ed59cb257ffb0be26378c37` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 239 | `4df8d7756b1713a3b84ecdc596062550a6723a08d89534315c005f91f96b45be` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `7ae88fd981317dbd514e16573f85c38dd85aa9cf644fdb342783623c6ef6868c` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `f3512a4e49ccec9aac11e2b1cc8aab60cba49784074a0366cf9268f6bece07e7` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `ec732a0608544cdb17fcfdff9b7950f34a02d8297fb7058a0fcac90cc28812de` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `c0595c568951856fae0f339fd2158c20c4043abaf32f8147b76bea7dd57126d0` |
...
define('ALOOKHOR_CC_VERSION', '3.10.124');
define('ALOOKHOR_CC_BUILD', '3.10.124');
...
/* v3.10.124 — reference-driven commerce UI, functional tabs, timer and mobile UX. */
...
/* v3.10.124 — Warm Luxury Surface revision: no stark-white section backgrounds. */
...
/* v3.10.124 — Owner-approved Rich Plum revision; replaces all warm large surfaces. */
...
import { initResponsive } from './core/responsive.js?v=3.10.124';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.124';
import { Config } from './core/config.js?v=3.10.124';
import { dashboardModule } from './modules/dashboard.js?v=3.10.124';
import { inventoryModule } from './modules/inventory.js?v=3.10.124';
import { ordersModule } from './modules/orders.js?v=3.10.124';
import { usersModule } from './modules/users.js?v=3.10.124';
import { analyticsModule } from './modules/analytics.js?v=3.10.124';
import { settingsModule } from './modules/settings.js?v=3.10.124';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.124');
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.124</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.124</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.124 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.124 — به‌روز</div>
          </div>
        </div>
