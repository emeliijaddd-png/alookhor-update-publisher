...
- CURRENT VERSION: `3.10.69`
- LAST FUNCTIONAL CHANGE: حذف هدر تکراری خارجی (علت نوار بالایی غیر تمام‌عرض) + فونت‌های بزرگ‌تر هدر.
...
CURRENT VERSION: 3.10.69
CHANGE: حذف هدر تکراری خارجی (علت نوار بالایی غیر تمام‌عرض) + فونت‌های بزرگ‌تر هدر.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.69 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.69 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.69 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.69 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.69 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.69 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.69 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.69 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.69 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.69 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.69 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.69 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.69 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.69 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.69 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.69 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.69 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.69 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.69 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.69 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.69 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.69 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.69 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.69 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.69 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.69 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.69 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 395 | `b55b0df0ea4464331f608c6f6e2b94cdbbb6c33583feee08425b943c665865f9` |
...
| `plugin/alookhor-control-center/assets/css/frontend-header-akx.css` | 878 | `d56b423f3734dbb03d30905779b95d267dcb50e1c8d94d7f0744c21cf4d76b52` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `630cd644b67c01ed5df327204596caf964d6009385f7b18af5fa6d58a27f6667` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 193 | `ed1ad12e1cd5eb7de3639b1445a0fb9ddc0e3a58807cc3bda5acbbf1993868a8` |
...
| `plugin/alookhor-control-center/assets/js/frontend-header-akx.js` | 151 | `842eee8bc9f75b7caaa17c5ffe0451277cd483ff51793c036c82e70d5fa14738` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `e798d6cefc2b43c76e4dd0cf5b987a8d8e19cc16deb742dcf14ccddd30ecb78d` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 662 | `47bd4ed991b5f36914f6c1135f36c859a5d1add11184cf6193edbe5d38d537d7` |
...
| `plugin/alookhor-control-center/config/site.json` | 288 | `07ac8dad03b47945a4740f16292dd3c2cf29667e94cc5d4da8d230461e847229` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `9ebd9841f9086b26b79781cdee8fbc73a050fb87bbab24ec45605c7421c83a90` |
...
define('ALOOKHOR_CC_VERSION', '3.10.69');
define('ALOOKHOR_CC_BUILD', '3.10.69');
...
#akx-header .akx-mainbar.is-stuck {
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
#akx-header .akx-mainbar-spacer { height: 0; }
#akx-header.akx-has-stuck-bar .akx-mainbar-spacer { display: block; }
@media (prefers-reduced-motion: reduce) {
  #akx-header .akx-mainbar.is-stuck { animation: none; }
}
...
import { initResponsive } from './core/responsive.js?v=3.10.69';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.69';
import { Config } from './core/config.js?v=3.10.69';
import { dashboardModule } from './modules/dashboard.js?v=3.10.69';
import { inventoryModule } from './modules/inventory.js?v=3.10.69';
import { ordersModule } from './modules/orders.js?v=3.10.69';
import { usersModule } from './modules/users.js?v=3.10.69';
import { analyticsModule } from './modules/analytics.js?v=3.10.69';
import { settingsModule } from './modules/settings.js?v=3.10.69';
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.69</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.69</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.69 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.69 — به‌روز</div>
          </div>
        </div>
