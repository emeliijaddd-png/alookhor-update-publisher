...
- **Plugin/source version:** `3.10.114`
...
- CURRENT VERSION: `3.10.114`
- LAST FUNCTIONAL CHANGE: حذف خودکار فاصله‌ها و نوارهای سفید کانتینرهای Elementor میزبان شورت‌کدهای مدیریت‌شده.
...
CURRENT VERSION: 3.10.114
CHANGE: حذف خودکار فاصله‌ها و نوارهای سفید کانتینرهای Elementor میزبان شورت‌کدهای مدیریت‌شده.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.114 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.114 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.114 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.114 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.114 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.114 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.114 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.114 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.114 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.114 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.114 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.114 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.114 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.114 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.114 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.114 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.114 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.114 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.114 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.114 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.114 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.114 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.114 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.114 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.114 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.114 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.114 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 408 | `126273983d7685ab2325f82bcd5cd81bbae00233beb173dcd79416791e7510e8` |
...
| `plugin/alookhor-control-center/assets/css/frontend-managed-layout.css` | 14 | `ee7bbcc3c5e1193f42b17ff7e823caa1cae87b99af445f55c5405208588bba06` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `0889d113b3d95dc77025e6c5125268d90000efbfc0c69175a3ffc99c0bfe0a5b` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 232 | `52025fe9fee4846dab1eb5d09debd66386a131765f00c98e0c2d39343c1ff10a` |
...
| `plugin/alookhor-control-center/assets/js/frontend-managed-layout.js` | 1 | `cc56bb0c2094296bdc2d6a6722e94be39dad01e50293b3beeec3ad30e718a33c` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `533059675b4b357693f7545c66fa6c5477fef558c001a6f93a2ac3ec39697e80` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `745f5f04f7de66533eb7f6e74c2ec4256ed516e4cdeedfff6090425c76578afe` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `09adf487bc0009f150cd61c68d266371d2b01ac46259c69174006bb2b2705168` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `cbab87b0b8e3df765e4f4dc11ed865ebea85df4ba7cee8f9c593db621e4836af` |
...
import { initResponsive } from './core/responsive.js?v=3.10.114';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.114';
import { Config } from './core/config.js?v=3.10.114';
import { dashboardModule } from './modules/dashboard.js?v=3.10.114';
import { inventoryModule } from './modules/inventory.js?v=3.10.114';
import { ordersModule } from './modules/orders.js?v=3.10.114';
import { usersModule } from './modules/users.js?v=3.10.114';
import { analyticsModule } from './modules/analytics.js?v=3.10.114';
import { settingsModule } from './modules/settings.js?v=3.10.114';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.114');
...
````javascript
(()=>{'use strict';const selector=['#alookhor-managed-hero','#alookhor-managed-features','#alookhor-managed-categories','#alookhor-managed-footer','.alookhor-sort-center','.alookhor-xb','.alookhor-app-banner','.alookhor-fp','.alookhor-campaign-wrap','.alookhor-bs','.alookhor-newsletter','.alookhor-mag'].join(',');function mark(root){if(root.dataset.layoutHostReady)return;root.dataset.layoutHostReady='1';const widget=root.closest('.elementor-widget-shortcode,.elementor-widget-html,.elementor-widget');if(widget){widget.classList.add('alookhor-managed-module-widget');const parent=widget.parentElement?.closest('.e-con,.elementor-section,.elementor-column');parent?.classList.add('alookhor-managed-module-host')}}function run(){document.querySelectorAll(selector).forEach(mark)}document.readyState==='loading'?document.addEventListener('DOMContentLoaded',run):run();new MutationObserver(run).observe(document.documentElement,{childList:true,subtree:true})})();
````
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.114</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.114</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.114 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.114 — به‌روز</div>
          </div>
        </div>
