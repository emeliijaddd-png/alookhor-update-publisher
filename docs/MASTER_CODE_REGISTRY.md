...
- **Plugin/source version:** `3.10.122`
...
- CURRENT VERSION: `3.10.122`
- LAST FUNCTIONAL CHANGE: جایگزینی سطوح روشن با بنفش آلویی پررنگ جدید و لوکس.
...
CURRENT VERSION: 3.10.122
CHANGE: جایگزینی سطوح روشن با بنفش آلویی پررنگ جدید و لوکس.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.122 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.122 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.122 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.122 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.122 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.122 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.122 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.122 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.122 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.122 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.122 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.122 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.122 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.122 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.122 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.122 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.122 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.122 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.122 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.122 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.122 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.122 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.122 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.122 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.122 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.122 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.122 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 413 | `e6971b1c52352caf2638696bde01318315ee16bd20aef25bb4bbedbdc6bff53b` |
...
| `plugin/alookhor-control-center/assets/css/frontend-bestsellers.css` | 24 | `c57a2533f48d96a2027ac2821497818c23e763726c78e86c4959a21a2d311f96` |
...
| `plugin/alookhor-control-center/assets/css/frontend-design-system.css` | 76 | `cb385b06ef54c72255ca0e8c63bce9fc19ef5391653df889b4d595c77e30b022` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `0d9158d34caaa07e4ca8e8845a6867c06c848cd7a4001c7e1183cac3e365a5da` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 239 | `8b7c3af52aa19fed7fcdbbdb1f4b4c869f1cce16dcc0118817ce6770394f0d79` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `afb0f70457bdba7ce212f7894a00f6346008ed527d3e8c9918bd72d2d60f4e96` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `42dd36d368c370a686dc39929ae168650265be0c79f0098accec20c7c71f690e` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `3f7ae3534c1c8e6139e6352e57983161c5c751fac40e6af43b2afeb47ebbb776` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `741fd1a6e221fbab68c8f23a720278b3df9be71193d57e505b484086ff1c71b5` |
...
define('ALOOKHOR_CC_VERSION', '3.10.122');
define('ALOOKHOR_CC_BUILD', '3.10.122');
...
/* v3.10.122 — reference-driven commerce UI, functional tabs, timer and mobile UX. */
...
/* v3.10.122 — Warm Luxury Surface revision: no stark-white section backgrounds. */
...
/* v3.10.122 — Owner-approved Rich Plum revision; replaces all warm large surfaces. */
...
import { initResponsive } from './core/responsive.js?v=3.10.122';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.122';
import { Config } from './core/config.js?v=3.10.122';
import { dashboardModule } from './modules/dashboard.js?v=3.10.122';
import { inventoryModule } from './modules/inventory.js?v=3.10.122';
import { ordersModule } from './modules/orders.js?v=3.10.122';
import { usersModule } from './modules/users.js?v=3.10.122';
import { analyticsModule } from './modules/analytics.js?v=3.10.122';
import { settingsModule } from './modules/settings.js?v=3.10.122';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.122');
...
export const Updater = {
  ...
  lastCheck: null,
  changelog: [
    { tag: 'RICH PLUM', title: 'v3.10.122 — بنفش آلویی پررنگ', desc: 'سطوح روشن با رنگ جدید #2B0D3A و کارت‌های بنفش برند جایگزین شدند.' },
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.122</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.122</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.122 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.122 — به‌روز</div>
          </div>
        </div>
