...
- **Plugin/source version:** `3.10.109`
...
- CURRENT VERSION: `3.10.109`
- LAST FUNCTIONAL CHANGE: انتشار مجدد هیروی بنفش و تصویر کامل پس از timeout موقت DNS وردپرس.
...
CURRENT VERSION: 3.10.109
CHANGE: انتشار مجدد هیروی بنفش و تصویر کامل پس از timeout موقت DNS وردپرس.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.109 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.109 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.109 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.109 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.109 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.109 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.109 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.109 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.109 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.109 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.109 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.109 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.109 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.109 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.109 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.109 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.109 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.109 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.109 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.109 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.109 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.109 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.109 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.109 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.109 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.109 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.109 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 402 | `3bee709b6e21223d3fbe2901c920818174cb5ef52514478bf072e4e19aac1e39` |
...
| `plugin/alookhor-control-center/assets/css/frontend-hero.css` | 81 | `4176d34b7caadb5c9f3f7dd27667abbce5f7d7fc43cfadbd24d899e9999ed8cb` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `9baf45e49bc92399aba68a2bdf5d18f6ce30993be337b635797ed6fb36b4d381` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 228 | `f8b09ab67c1791f7da532af6b16f762e194f2afac2f52b69229b96e1e4d3c8c0` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `55d71cfd4cd297c5ed874190c4970f747547bd3cc831c6edcf6eb40a46801e52` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `19b62638e798e6bf5e55bbfdbbf5fbf248ac0b4470d0a1ab6b915cef1a2a0cd2` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `59ff64977fc1f6b672437665943a65869d8724f3aa0475646476bf853e469df5` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `aeea327a0b742aac6e1a35eddf230919443fd0d1c8ebf33ab30eba11a5845c5f` |
...
define('ALOOKHOR_CC_VERSION', '3.10.109');
define('ALOOKHOR_CC_BUILD', '3.10.109');
...
/* v3.10.109 — purple brand treatment + uncropped complete banner photography. */
...
import { initResponsive } from './core/responsive.js?v=3.10.109';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.109';
import { Config } from './core/config.js?v=3.10.109';
import { dashboardModule } from './modules/dashboard.js?v=3.10.109';
import { inventoryModule } from './modules/inventory.js?v=3.10.109';
import { ordersModule } from './modules/orders.js?v=3.10.109';
import { usersModule } from './modules/users.js?v=3.10.109';
import { analyticsModule } from './modules/analytics.js?v=3.10.109';
import { settingsModule } from './modules/settings.js?v=3.10.109';
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.109</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.109</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.109 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.109 — به‌روز</div>
          </div>
        </div>
