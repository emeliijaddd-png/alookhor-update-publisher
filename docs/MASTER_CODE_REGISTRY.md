...
- **Plugin/source version:** `3.10.121`
...
- CURRENT VERSION: `3.10.121`
- LAST FUNCTIONAL CHANGE: جایگزینی سطوح سفید سرد با سیستم Warm Luxury هماهنگ با آلوی بنفش و هسته طلایی.
...
CURRENT VERSION: 3.10.121
CHANGE: جایگزینی سطوح سفید سرد با سیستم Warm Luxury هماهنگ با آلوی بنفش و هسته طلایی.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.121 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.121 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.121 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.121 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.121 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.121 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.121 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.121 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.121 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.121 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.121 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.121 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.121 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.121 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.121 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.121 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.121 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.121 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.121 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.121 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.121 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.121 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.121 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.121 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.121 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.121 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.121 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 413 | `06106d7a791107532767632b4293a9d3ceb7f0e1c15f4c8306fae68b96afd5c5` |
...
| `plugin/alookhor-control-center/assets/css/frontend-bestsellers.css` | 24 | `a168c03f77eb25903aaddd86068ff9a26ab3be34184a3f7460e49d89d362fb63` |
...
| `plugin/alookhor-control-center/assets/css/frontend-design-system.css` | 58 | `dd8cea3ad257281fc4ff8c23244afe0e86a7daf235d6aa88a921abfa7b7a4473` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `82cdcce1c3b46b81427f072f50893b356fee5f8d2d35069705f16bc264f08d83` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 238 | `a70e144a5e24357c7da73103ddbd0734752ed642eb842a542ea035de3b838e5d` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `1c68184708c227a813ec75eb64d634f10b3dba9fc94584f3311cf2d72dd841ec` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `cb2851cc2080824d9efd34442b4f83e27f387b9210c39245d89012cffd8b4593` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `9df52351bc179d82090074c17cc0f989c3e16a74d1e737a3b8454a692658fd4b` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `ce636dd71b1d0348317a182d7396be241fcdd45afb950acb337579d0fafed6df` |
...
define('ALOOKHOR_CC_VERSION', '3.10.121');
define('ALOOKHOR_CC_BUILD', '3.10.121');
...
/* v3.10.121 — reference-driven commerce UI, functional tabs, timer and mobile UX. */
...
/* v3.10.121 — Warm Luxury Surface revision: no stark-white section backgrounds. */
...
import { initResponsive } from './core/responsive.js?v=3.10.121';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.121';
import { Config } from './core/config.js?v=3.10.121';
import { dashboardModule } from './modules/dashboard.js?v=3.10.121';
import { inventoryModule } from './modules/inventory.js?v=3.10.121';
import { ordersModule } from './modules/orders.js?v=3.10.121';
import { usersModule } from './modules/users.js?v=3.10.121';
import { analyticsModule } from './modules/analytics.js?v=3.10.121';
import { settingsModule } from './modules/settings.js?v=3.10.121';
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.121</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.121</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.121 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.121 — به‌روز</div>
          </div>
        </div>
