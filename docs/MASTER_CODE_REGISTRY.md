...
- **Plugin/source version:** `3.10.108`
...
- CURRENT VERSION: `3.10.108`
- LAST FUNCTIONAL CHANGE: هماهنگ‌سازی اسلایدر بالای سایت با تم بنفش و نمایش کامل تصاویر بدون برش.
...
CURRENT VERSION: 3.10.108
CHANGE: هماهنگ‌سازی اسلایدر بالای سایت با تم بنفش و نمایش کامل تصاویر بدون برش.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.108 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.108 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.108 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.108 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.108 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.108 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.108 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.108 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.108 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.108 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.108 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.108 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.108 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.108 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.108 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.108 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.108 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.108 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.108 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.108 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.108 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.108 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.108 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.108 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.108 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.108 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.108 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 402 | `54ed39c6ec7840cd84b1f4e69db55d7bb7367189c953cb884815da09a976fa2b` |
...
| `plugin/alookhor-control-center/assets/css/frontend-header-akx.css` | 956 | `788988f4de14c275c5d44b041e27232c82d0def29eddea9b7600af4ec32575db` |
...
| `plugin/alookhor-control-center/assets/css/frontend-hero.css` | 81 | `01b241aeb1c4def0052e6c5e004044999bf0a4ef7721679cdb27fabf293f1202` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `14c19dcff2feed6fdb9e7b1a6583be3a520a05260f2ac47217c2abca08053336` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 228 | `b720c2f2832d1c32b81f83f729b06578023114567a2f84082f6e765935b5e916` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `9e115bfc3f2c99587aa36131ffdb48c9d3f87193071527371fae254dc8d1b573` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `6ae1e9222ed1feafe73f0e4532e0a9c207951b45f9cabf7ee45fc1dd86f89a76` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `65ce684302318fdc0e2439c4c8db9fb7a3bb88134070d531ddf83e204e5edd12` |
...
| `plugin/alookhor-control-center/includes/shortcode-header.php` | 369 | `5994c35ec61201ad2d546439a354ff7c46d42f307dbbbd083c20982964ae11df` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `4d1e7159c4ac7b760655ad253b265b0f081cf89c322082c8922215a977a118bb` |
...
define('ALOOKHOR_CC_VERSION', '3.10.108');
define('ALOOKHOR_CC_BUILD', '3.10.108');
...
/* v3.10.108 — purple brand treatment + uncropped complete banner photography. */
...
import { initResponsive } from './core/responsive.js?v=3.10.108';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.108';
import { Config } from './core/config.js?v=3.10.108';
import { dashboardModule } from './modules/dashboard.js?v=3.10.108';
import { inventoryModule } from './modules/inventory.js?v=3.10.108';
import { ordersModule } from './modules/orders.js?v=3.10.108';
import { usersModule } from './modules/users.js?v=3.10.108';
import { analyticsModule } from './modules/analytics.js?v=3.10.108';
import { settingsModule } from './modules/settings.js?v=3.10.108';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.108');
...
export const Updater = {
  ...
  lastCheck: null,
  changelog: [
    { tag: 'PURPLE HERO', title: 'v3.10.108 — هیروی بنفش با تصویر کامل', desc: 'پس‌زمینه Hero بنفش شد و تصاویر بدون برش، Shift یا Zoom کامل نمایش داده می‌شوند.' },
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.108</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.108</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.108 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.108 — به‌روز</div>
          </div>
        </div>
