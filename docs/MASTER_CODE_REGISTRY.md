...
- **Plugin/source version:** `3.10.118`
...
- CURRENT VERSION: `3.10.118`
- LAST FUNCTIONAL CHANGE: انتشار مجدد UX پرفروش‌ها پس از timeout موقت DNS بررسی Manifest.
...
CURRENT VERSION: 3.10.118
CHANGE: انتشار مجدد UX پرفروش‌ها پس از timeout موقت DNS بررسی Manifest.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.118 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.118 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.118 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.118 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.118 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.118 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.118 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.118 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.118 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.118 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.118 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.118 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.118 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.118 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.118 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.118 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.118 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.118 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.118 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.118 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.118 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.118 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.118 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.118 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.118 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.118 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.118 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 408 | `df6173fddfd6ece5785ce97dc7ca10dae83ec5a6a09f583813e4aa83045a0836` |
...
| `plugin/alookhor-control-center/assets/css/frontend-bestsellers.css` | 24 | `ade34379936bfe31c7aaab3bdb3e9f64c767e9f457fdd4a15dd3b2f91b7d53d0` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `da40de76664df1bf0272fb41290f062496cea9d9d5a2909b8ed0542daacf1016` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 235 | `03fff3a0a23bb0685621c50c0e2f3c27dcfc5b6124c3586c13e9b11fa07f6a39` |
| `plugin/alookhor-control-center/assets/js/frontend-bestsellers.js` | 1 | `56817606b4ce3d9dccbd3fe66d23f9c7a335f42a988e4ba6c1898e94b4fe958f` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `1149e90c9502a7c9272131b5bb12c50d6803795e132e5ddc859a923db8b8cd4f` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `f06c8e0db2e03517923f66e848eeda25caad4356b24ae25e9da01cfc075cbd00` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `f451c37edd4ac75475ce60deb994a243ddda2b76907f126e40cee583a4cb0bf6` |
...
| `plugin/alookhor-control-center/includes/bestselling-products.php` | 14 | `5b49164d56467361989f29f74e9370da47ff9c832c908d2fcfce32c7d6bd4657` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `3acb19828df049ef82f3d8852889b7b64d5a8915caafa375ae47035c5f3c1829` |
...
define('ALOOKHOR_CC_VERSION', '3.10.118');
define('ALOOKHOR_CC_BUILD', '3.10.118');
...
/* v3.10.118 — reference-driven commerce UI, functional tabs, timer and mobile UX. */
...
import { initResponsive } from './core/responsive.js?v=3.10.118';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.118';
import { Config } from './core/config.js?v=3.10.118';
import { dashboardModule } from './modules/dashboard.js?v=3.10.118';
import { inventoryModule } from './modules/inventory.js?v=3.10.118';
import { ordersModule } from './modules/orders.js?v=3.10.118';
import { usersModule } from './modules/users.js?v=3.10.118';
import { analyticsModule } from './modules/analytics.js?v=3.10.118';
import { settingsModule } from './modules/settings.js?v=3.10.118';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.118');
...
````javascript
(()=>{'use strict';const fa=n=>Number(n).toLocaleString('fa-IR');function visible(root){return [...root.querySelectorAll('.abs-card:not([hidden])')]}function animate(root,dir){root.classList.remove('is-slide-next','is-slide-prev');void root.offsetWidth;root.classList.add(dir==='next'?'is-slide-next':'is-slide-prev')}function move(root,dir){const track=root.querySelector('.abs-grid'),cards=visible(root);if(!track||cards.length<2)return;if(dir==='next')track.append(cards[0]);else track.prepend(cards[cards.length-1]);track.style.transform='none';animate(root,dir)}function start(root){if(root._absTimer)clearInterval(root._absTimer);if(root.dataset.autoplay==='1')root._absTimer=setInterval(()=>move(root,'next'),Math.max(2500,Number(root.dataset.interval)||5000))}function init(root){if(root.dataset.bsRuntime==='3')return;root.dataset.bsRuntime='3';root.querySelector('.abs-grid')?.style.setProperty('transform','none','important');root.addEventListener('mouseenter',()=>clearInterval(root._absTimer));root.addEventListener('mouseleave',()=>start(root));start(root)}function boot(){document.querySelectorAll('.alookhor-bs').forEach(init)}document.addEventListener('click',e=>{const button=e.target.closest('.alookhor-bs button');if(!button)return;const root=button.closest('.alookhor-bs');if(button.matches('[data-cat]')){root.querySelectorAll('[data-cat]').forEach(b=>b.classList.toggle('is-active',b===button));const cat=button.dataset.cat;root.querySelectorAll('.abs-card').forEach(card=>card.hidden=cat!=='all'&&!card.dataset.cats.split(' ').includes(cat));root.querySelector('.abs-grid')?.style.setProperty('transform','none','important');animate(root,'next');start(root)}else if(button.classList.contains('abs-next')){move(root,'next');start(root)}else if(button.classList.contains('abs-prev')){move(root,'prev');start(root)}});function countdown(){const now=Math.floor(Date.now()/1000);document.querySelectorAll('.abs-timer[data-deadline]').forEach(timer=>{let d=Math.max(0,Number(timer.dataset.deadline)-now);const units={days:Math.floor(d/86400),hours:Math.floor(d%86400/3600),minutes:Math.floor(d%3600/60),seconds:d%60};Object.entries(units).forEach(([key,value])=>{const el=timer.querySelector(`[data-unit="${key}"]`);if(el)el.textContent=fa(value)})})}document.readyState==='loading'?document.addEventListener('DOMContentLoaded',boot):boot();countdown();setInterval(countdown,1000);new MutationObserver(boot).observe(document.documentElement,{childList:true,subtree:true})})();
````
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.118</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.118</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.118 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.118 — به‌روز</div>
          </div>
        </div>
