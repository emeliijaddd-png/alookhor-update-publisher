...
- **Plugin/source version:** `3.10.123`
...
- CURRENT VERSION: `3.10.123`
- LAST FUNCTIONAL CHANGE: انتشار مجدد سطوح Rich Plum پس از timeout موقت DNS وردپرس.
...
CURRENT VERSION: 3.10.123
CHANGE: انتشار مجدد سطوح Rich Plum پس از timeout موقت DNS وردپرس.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.123 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.123 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.123 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.123 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.123 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.123 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.123 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.123 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.123 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.123 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.123 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.123 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.123 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.123 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.123 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.123 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.123 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.123 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.123 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.123 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.123 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.123 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.123 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.123 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.123 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.123 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.123 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 413 | `66dcbfc37a164377b7ff422b94a92222916efbb13cdc7dd5877bbaac2aa9cdfb` |
...
| `plugin/alookhor-control-center/assets/css/frontend-bestsellers.css` | 24 | `10b68347a169031fae27f269866704c6fb28d2378207d38235f86f1581e504f4` |
...
| `plugin/alookhor-control-center/assets/css/frontend-design-system.css` | 76 | `345b4a27c0c1412bd4e215b6a61c04600ef6d82d4e6a51711fae07679d991130` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `eb44fdbd9123c37d05b8181d7aee49ec00934bca45d86903adbc0f16f661244c` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 239 | `f050d4404bea94d512cb97b67a39b136a6620eabadeea96ee5185c13b9e246a6` |
...
| `plugin/alookhor-control-center/assets/js/frontend-managed-layout.js` | 1 | `61803f02406451d8cd57ebe4d83519088b5a7b3aa67d812267e7794c7d82034b` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `49aa581624a4490836773b40b194e989388cdb5a242457b1a8e945cdf491f3ec` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `419f7138d149555cd5a504daaa58cd95b28e1c723b0536966f207b8a4856b0b8` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `c3862ab98d7e3f9827105f8478baeae98145746f3bc45f3030e6523c629d9197` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `ff8fca99e4c3a127b8245aa447f8bdab407ed597a8be0bd6363160ce15fccfb8` |
...
define('ALOOKHOR_CC_VERSION', '3.10.123');
define('ALOOKHOR_CC_BUILD', '3.10.123');
...
/* v3.10.123 — reference-driven commerce UI, functional tabs, timer and mobile UX. */
...
/* v3.10.123 — Warm Luxury Surface revision: no stark-white section backgrounds. */
...
/* v3.10.123 — Owner-approved Rich Plum revision; replaces all warm large surfaces. */
...
import { initResponsive } from './core/responsive.js?v=3.10.123';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.123';
import { Config } from './core/config.js?v=3.10.123';
import { dashboardModule } from './modules/dashboard.js?v=3.10.123';
import { inventoryModule } from './modules/inventory.js?v=3.10.123';
import { ordersModule } from './modules/orders.js?v=3.10.123';
import { usersModule } from './modules/users.js?v=3.10.123';
import { analyticsModule } from './modules/analytics.js?v=3.10.123';
import { settingsModule } from './modules/settings.js?v=3.10.123';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.123');
...
export const Updater = {
  ...
  lastCheck: null,
  changelog: [
    { tag: 'RICH PLUM', title: 'v3.10.123 — بنفش آلویی پررنگ', desc: 'سطوح روشن با رنگ جدید #2B0D3A و کارت‌های بنفش برند جایگزین شدند.' },
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.123</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.123</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.123 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.123 — به‌روز</div>
          </div>
        </div>
