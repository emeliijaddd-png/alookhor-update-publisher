...
- **Plugin/source version:** `3.10.142`
...
- CURRENT VERSION: `3.10.142`
- LAST FUNCTIONAL CHANGE: اصلاح جهت نمایش شماره‌های واتساپ و جایگزینی حرف آ با لوگوی رسمی در بنر صادراتی.
...
CURRENT VERSION: 3.10.142
CHANGE: اصلاح جهت نمایش شماره‌های واتساپ و جایگزینی حرف آ با لوگوی رسمی در بنر صادراتی.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.142 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.142 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.142 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.142 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.142 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.142 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.142 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.142 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.142 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.142 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.142 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.142 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.142 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.142 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.142 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.142 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.142 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.142 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.142 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.142 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.142 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.142 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.142 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.142 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.142 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.142 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.142 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 426 | `0ef83265f816ac5f15ced920c65d7c87fa7ea663bbe5230f9b12699987a0dcf8` |
...
| `plugin/alookhor-control-center/assets/css/frontend-export-banner.css` | 316 | `7d24b2b30b4453901d121da782b00929623a8a6a2e0a106e514b9eeb1bff4689` |
...
| `plugin/alookhor-control-center/assets/css/frontend-newsletter.css` | 1 | `23a40d4bddfa50dacae00285a966e644013f17044c1322b2982c45f1e735f05c` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `233b4775f4309848bd966f27f4b78dbb61ef54a7d6b031776123d0c945e5f1d0` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 254 | `d94662a8833f954f0a19592f2cb83a4a5f5eb5f64de22b95e101616b9d4b6d15` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `7c0c75b86dc278db48bcb67253ca2e0395d82145cbb2393996157574f2689f3d` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 787 | `6d48eef6e77b4dd24bfb6e881b7b6f155abe7462715757bc8a3f7a37c601053f` |
...
| `plugin/alookhor-control-center/config/site.json` | 328 | `7b610863ff4b8cb5fec75f5a0102e8a4eed8d38649d89dee92bf91fd0164ba9f` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `563d14ba68dcb922985aa880189007b63b21a5c10f9bd95349ca116800cda12a` |
...
define('ALOOKHOR_CC_VERSION', '3.10.142');
define('ALOOKHOR_CC_BUILD', '3.10.142');
...
/* v3.10.142 — stable phone bidi and official logo fallback presentation. */
...
import { initResponsive } from './core/responsive.js?v=3.10.142';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.142';
import { Config } from './core/config.js?v=3.10.142';
import { dashboardModule } from './modules/dashboard.js?v=3.10.142';
import { inventoryModule } from './modules/inventory.js?v=3.10.142';
import { ordersModule } from './modules/orders.js?v=3.10.142';
import { usersModule } from './modules/users.js?v=3.10.142';
import { analyticsModule } from './modules/analytics.js?v=3.10.142';
import { settingsModule } from './modules/settings.js?v=3.10.142';
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.142</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.142</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.142 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.142 — به‌روز</div>
          </div>
        </div>
