...
- **Plugin/source version:** `3.10.150`
...
- CURRENT VERSION: `3.10.150`
- LAST FUNCTIONAL CHANGE: فشرده‌سازی پنل موبایل Hero، حذف ویژگی‌ها و اصلاح جهت فلش‌ها.
...
CURRENT VERSION: 3.10.150
CHANGE: فشرده‌سازی پنل موبایل Hero، حذف ویژگی‌ها و اصلاح جهت فلش‌ها.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.150 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.150 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.150 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.150 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.150 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.150 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.150 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.150 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.150 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.150 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.150 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.150 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.150 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.150 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.150 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.150 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.150 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.150 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.150 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.150 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.150 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.150 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.150 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.150 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.150 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.150 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.150 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 426 | `ecd97290de5c597b0ce3fac54571f5e4bac59a57e3e64f450cf7b0dec34ed1af` |
...
| `plugin/alookhor-control-center/assets/css/frontend-categories.css` | 19 | `3197c66d719994531247963d353d689154d4f9f8f946e1b18a8661546e7e49e7` |
...
| `plugin/alookhor-control-center/assets/css/frontend-export-banner.css` | 316 | `c0414afcae11f8c50ee6f665b6a059c023397348e8b3c2ae0f92025d88c2fcb5` |
...
| `plugin/alookhor-control-center/assets/css/frontend-header-akx.css` | 1019 | `aebe8bb6c6fa827ea0b18f7b48fca9e6a956b1f7b770a8f68b1b3f57c51a17b9` |
...
| `plugin/alookhor-control-center/assets/css/frontend-hero.css` | 160 | `b1bd9fb7db31ecbd8718f3827e9d77170c33bded1334e5856e4eafe909102ab3` |
...
| `plugin/alookhor-control-center/assets/css/frontend-newsletter.css` | 7 | `35f66487738c7921165d52176e00c919912086c91b3efcac83b984774a3f29c5` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `11b4dea2c573125ea33b0bd4439a63a286323ed61903734dc497286605c9ef15` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 262 | `3b488e36f75d42164ade7fe40b0096f750f5f0c474986cb85dd5b18f2fcafeda` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `ba2259dc32237247d4c91e5a109f0a23ac3ff8181a8cd60f910648b68e370aa4` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 787 | `90d5f4397e21f45d6a7136b1847d950a7a28f7fbab1fc4b50ff55f0bc7152273` |
...
| `plugin/alookhor-control-center/config/site.json` | 328 | `00a97693d9fde59c094f56f3b977042f45cba08a81adf6658bc44ec1e82b5b30` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `0442f47e70e430a9dc7fbf9d3901bfa283e08896d5a4886487b6bb9e659aacf9` |
...
define('ALOOKHOR_CC_VERSION', '3.10.150');
define('ALOOKHOR_CC_BUILD', '3.10.150');
...
/* v3.10.150 — luminous editorial category heading hierarchy. */
...
/* v3.10.150 — stable phone bidi and official logo fallback presentation. */
...
/* v3.10.150 — lock every desktop navigation item to one optical baseline. */
...
/* v3.10.150 — mobile-first Header UX and accessible drawer. */
...
/* v3.10.150 — editorial Persian hero typography matching approved references. */
...
/* v3.10.150 — editorial description divider with two fine gold arrow-lines. */
...
/* v3.10.150 — independent mobile Hero composition (not a scaled desktop layout). */
@media(max-width:767px){
...
/* v3.10.150 — compact corner glass card for mobile Hero. */
@media(max-width:767px){
...
/* v3.10.150 — newsletter/discount card matches the app-banner footprint. */
...
import { initResponsive } from './core/responsive.js?v=3.10.150';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.150';
import { Config } from './core/config.js?v=3.10.150';
import { dashboardModule } from './modules/dashboard.js?v=3.10.150';
import { inventoryModule } from './modules/inventory.js?v=3.10.150';
import { ordersModule } from './modules/orders.js?v=3.10.150';
import { usersModule } from './modules/users.js?v=3.10.150';
import { analyticsModule } from './modules/analytics.js?v=3.10.150';
import { settingsModule } from './modules/settings.js?v=3.10.150';
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.150</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.150</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.150 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.150 — به‌روز</div>
          </div>
        </div>
