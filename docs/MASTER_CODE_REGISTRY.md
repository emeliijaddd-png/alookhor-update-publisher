...
- **Plugin/source version:** `3.10.137`
...
- CURRENT VERSION: `3.10.137`
- LAST FUNCTIONAL CHANGE: افزودن زیرخط طلایی متحرک برای Hover و Focus منوی اصلی.
...
CURRENT VERSION: 3.10.137
CHANGE: افزودن زیرخط طلایی متحرک برای Hover و Focus منوی اصلی.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.137 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.137 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.137 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.137 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.137 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.137 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.137 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.137 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.137 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.137 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.137 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.137 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.137 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.137 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.137 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.137 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.137 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.137 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.137 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.137 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.137 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.137 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.137 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.137 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.137 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.137 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.137 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 425 | `c7ef9c893c024267ffb507ae7f4a4224a4cf92858f5f5b40e268bec51c55b369` |
...
| `plugin/alookhor-control-center/assets/css/frontend-header-akx.css` | 982 | `3b2746d35d8f411f591725ab81401ba91dfe559c2e2b56bb2011f52594bfcfde` |
...
| `plugin/alookhor-control-center/assets/css/frontend-why-alookhor.css` | 4 | `5b7ed58024f4218518f27f5056080c26440e90a046133c4545f4b37387186557` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `ba9c6a42e2f791abca35ff23084111fc52af01d757ef9688dd875cff5eb5bef7` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 250 | `281df2d735b2fadb96034ebaee654ddbe355fc667bc242dac2f076502fd0eacb` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `79c43988b23c7b11fa368507974944dee1ce6e53da9bac088d60df038450e1a6` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 780 | `c276ace40698b5a1f12e3de0707dd94f89b0e953a1a8325ec4ccb2e36fce7fef` |
...
| `plugin/alookhor-control-center/config/site.json` | 323 | `b542f7ac3ddd577c1e7c7580cc254930150f18ab19baa8917f854793ad0180a6` |
...
| `plugin/alookhor-control-center/includes/why-alookhor.php` | 14 | `376f3b45110c4dd61db5fcb06fa063d111e8f8a42885769a2e7cefbe479fa793` |
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `2a295535dc576af1d58bf673a612e9be6dad8695c5c5daed7f80e6666d8cde81` |
...
define('ALOOKHOR_CC_VERSION', '3.10.137');
define('ALOOKHOR_CC_BUILD', '3.10.137');
...
/* v3.10.137 — thin continuous luminous frame around the main glass capsule. */
...
/* v3.10.137 — animated gold navigation indicator. */
...
/* v3.10.137 — luxury glass trust treatment inspired by the approved standards reference. */
...
import { initResponsive } from './core/responsive.js?v=3.10.137';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.137';
import { Config } from './core/config.js?v=3.10.137';
import { dashboardModule } from './modules/dashboard.js?v=3.10.137';
import { inventoryModule } from './modules/inventory.js?v=3.10.137';
import { ordersModule } from './modules/orders.js?v=3.10.137';
import { usersModule } from './modules/users.js?v=3.10.137';
import { analyticsModule } from './modules/analytics.js?v=3.10.137';
import { settingsModule } from './modules/settings.js?v=3.10.137';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.137');
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.137</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.137</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.137 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.137 — به‌روز</div>
          </div>
        </div>
