...
- CURRENT VERSION: `3.10.30`
- LAST FUNCTIONAL CHANGE: تله‌متری تشخیص رندر هدر موبایل در تست پسا‌آپدیت — بدون هیچ تغییر رفتاری در محصول.
...
```text
PROJECT: ALOOKHOR
AREA: Purple Glass Header + Purple Slider / Desktop + Mobile
CURRENT VERSION: 3.10.30
CHANGE: تله‌متری تشخیص رندر هدر موبایل در تست پسا‌آپدیت — بدون هیچ تغییر رفتاری در محصول.
REASON: گزارش کاربر: «هدر در حالت موبایل رفته سمت راست». برای فیکس دقیق و امن، ابتدا اندازه‌گیری رندرشده‌ی زنده‌ی هدر موبایل لازم است — این نسخه فقط تله‌متری اضافه می‌کند تا فیکس بعدی مبتنی بر شواهد باشد.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.30 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.30 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.30 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.30 | Active |
| SC-005 | Shortcode | `[alookhor_purple_slider]` | `includes/shortcode-purple-slider.php` | Elementor Shortcode widget / any page | 3.10.30 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.30 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.30 | Active mirror |
| PN-003 | Admin panel | Purple Glass Slider | `includes/admin-purple-slider.php` | WP Admin submenu | 3.10.30 | Active |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.30 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.30 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.30 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.30 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.30 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.30 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.30 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.30 | Active |
| CFG-003 | WordPress state | Purple slider | `alookhor_cc_purple_slider` | `[alookhor_purple_slider]` | 3.10.30 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.30 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.30 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.30 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.30 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.30 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.30 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.30 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.30 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.30 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.30 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.30 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.30 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.30 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 374 | `e2cf0a58da54b7a716008d512814e1c597aa808d1480e5be05dee5399daedcd8` |
...
| `plugin/alookhor-control-center/assets/css/frontend-header.css` | 437 | `1747fd422fe1054eba4640d78e0aab8e4bb60a8f5186534e74ba11eb5e209fb4` |
...
| `plugin/alookhor-control-center/config/site.json` | 285 | `c599b5d4e3676f6270b3c0ea785a78b56b13bef96c60f515a0cb368cd0fec786` |
...
| `plugin/alookhor-control-center/includes/admin.php` | 253 | `2676d0f74cb9f20ba40a0e34ba20888d577bf0a5f51783d746890d4a24bd31a5` |
| `plugin/alookhor-control-center/includes/ajax.php` | 427 | `187d9e590e661359bc3da6ade9aa547025577f2edc3b6d430d8fb50851ac67f8` |
...
| `plugin/alookhor-control-center/includes/shortcode-header.php` | 370 | `6ac42ef3720a5dec2b36f0440d44931acf602b1864008a5d20aacfadd78a09e9` |
...
define('ALOOKHOR_CC_VERSION', '3.10.30');
define('ALOOKHOR_CC_BUILD', '3.10.30');
