...
- **Plugin/source version:** `3.10.125`
...
- CURRENT VERSION: `3.10.125`
- LAST FUNCTIONAL CHANGE: اجرای ریتم یکی‌درمیان دو بنفش #2B0A3D و #3A0D5C روی کانتینرهای Homepage.
...
CURRENT VERSION: 3.10.125
CHANGE: اجرای ریتم یکی‌درمیان دو بنفش #2B0A3D و #3A0D5C روی کانتینرهای Homepage.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.125 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.125 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.125 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.125 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.125 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.125 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.125 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.125 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.125 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.125 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.125 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.125 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.125 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.125 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.125 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.125 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.125 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.125 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.125 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.125 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.125 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.125 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.125 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.125 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.125 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.125 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.125 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 413 | `c842a07ebf2ddfd36012ab259e72f79a3946d455f76717527a3d3acb2d65a6d1` |
...
| `plugin/alookhor-control-center/assets/css/frontend-design-system.css` | 88 | `99a9b76127f0ee5736b9cfdef2437487fb2c7a14a7f0e9e6af5a165fcb24283e` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `c121fd56a528ccfc240819e2c7f2bd736c07fee6d3e2dd8830f4bb1b5a9c2754` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 240 | `433d62b9396b6d5b037b098be80d4bbb08aa69c3f6e23a8887e2cfcdcf41e0f0` |
...
| `plugin/alookhor-control-center/assets/js/frontend-managed-layout.js` | 1 | `d982a1e79a7880dfe27c2e82653bee0e148e6539fd69216fefbc40dfa8910869` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `5587cfdc3b39d36a11b6950004affd494fece973ae1c988943d8f5c71ab1d4c5` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 773 | `a4bb415b404f9c63d50e179c184f2e5804ddad26a3f6d197bd0b8f0c89411829` |
...
| `plugin/alookhor-control-center/config/site.json` | 318 | `65b14c3a9540c60af78c28752f0f9c8676dec431d77f64eae447006d7aaa6d9a` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `4f3e8c6f5aa0fe87b46047cee6e6528b99c3441c89faf00a687c3636059b94c4` |
...
define('ALOOKHOR_CC_VERSION', '3.10.125');
define('ALOOKHOR_CC_BUILD', '3.10.125');
...
/* v3.10.125 — Warm Luxury Surface revision: no stark-white section backgrounds. */
...
/* v3.10.125 — Owner-approved Rich Plum revision; replaces all warm large surfaces. */
...
/* v3.10.125 — alternating plum rhythm requested by owner. */
...
import { initResponsive } from './core/responsive.js?v=3.10.125';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.125';
import { Config } from './core/config.js?v=3.10.125';
import { dashboardModule } from './modules/dashboard.js?v=3.10.125';
import { inventoryModule } from './modules/inventory.js?v=3.10.125';
import { ordersModule } from './modules/orders.js?v=3.10.125';
import { usersModule } from './modules/users.js?v=3.10.125';
import { analyticsModule } from './modules/analytics.js?v=3.10.125';
import { settingsModule } from './modules/settings.js?v=3.10.125';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.125');
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.125</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.125</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.125 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.125 — به‌روز</div>
          </div>
        </div>
