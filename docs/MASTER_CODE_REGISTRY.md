...
- **Plugin/source version:** `3.10.135`
...
- CURRENT VERSION: `3.10.135`
- LAST FUNCTIONAL CHANGE: ارتقای بخش چرا آلوخور با کارت‌های شیشه‌ای، انیمیشن ظریف و شمارنده‌های پویا.
...
CURRENT VERSION: 3.10.135
CHANGE: ارتقای بخش چرا آلوخور با کارت‌های شیشه‌ای، انیمیشن ظریف و شمارنده‌های پویا.
...
|---|---|---|---|---|---:|---|
| SC-001 | Shortcode | `[alookhor_portal_header]` | `includes/shortcode-header.php` | Elementor Header Shortcode widget; exact template ID unavailable | 3.10.135 | Active / compatibility-preserving |
| SC-002 | Shortcode | `[alookhor_managed_categories]` | `includes/product-categories.php` | Home page → Elementor Shortcode widget | 3.10.135 | Active |
| SC-003 | Shortcode | `[alookhor_managed_hero]` | `includes/hero.php` | Home Elementor Shortcode widget / automatic Legacy-root replacement | 3.10.135 | Active |
| SC-004 | Shortcode | `[alookhor_managed_features]` | `includes/site-features.php` | Home Elementor HTML widget / automatic Legacy-root replacement | 3.10.135 | Active |
...
| PN-001 | Admin panel | ALOOKHOR Control Center | `includes/admin.php` | WP Admin top-level menu | 3.10.135 | Active |
| PN-002 | Admin panel | Header & Top Bar | `includes/admin.php` | WP Admin submenu | 3.10.135 | Active mirror |
| MOD-001 | Managed module | WooCommerce Categories | `includes/product-categories.php` | Home / Elementor / REST | 3.10.135 | Active |
| MOD-002 | Managed module | Responsive Footer | `includes/footer.php` | Frontend footer / REST | 3.10.135 | Active |
| MOD-003 | Managed module | Four-slide Hero | `includes/hero.php` | Home / Elementor / REST | 3.10.135 | Active |
| MOD-004 | Managed module | Four-card Site Features | `includes/site-features.php` | Home / Elementor / REST | 3.10.135 | Active |
| API-001 | REST API | `alookhor-cc/v1` | `includes/rest-api.php` | Public state + authenticated updater | 3.10.135 | Active |
| UPD-001 | Updater | Private native updater | `includes/updater.php` | Control Center + GitHub Actions | 3.10.135 | Active |
| CFG-001 | WordPress state | Main settings | `alookhor_cc_settings` | All managed modules | 3.10.135 | Active |
| CFG-002 | WordPress state | Header settings | `alookhor_header_settings` | Header and Top Bar | 3.10.135 | Active |
| CSS-001 | CSS | Managed Header | `assets/css/frontend-header.css` | `[alookhor_portal_header]` fallback renderer | 3.10.135 | Active |
| JS-001 | JavaScript | Managed Header runtime | `assets/js/frontend-header.js` | `[alookhor_portal_header]` fallback renderer | 3.10.135 | Active |
| JS-002 | JavaScript | Legacy Top Bar manager | `assets/js/frontend-topbar-manager.js` | Preserved legacy header provider | 3.10.135 | Active when legacy provider exists |
| CSS-002 | CSS | WooCommerce Categories | `assets/css/frontend-categories.css` | `[alookhor_managed_categories]` | 3.10.135 | Active |
| JS-003 | JavaScript | Categories carousel | `assets/js/frontend-categories.js` | `[alookhor_managed_categories]` | 3.10.135 | Active |
| CSS-003 | CSS | Managed Footer | `assets/css/frontend-footer.css` | Managed Footer module | 3.10.135 | Active |
| JS-004 | JavaScript | Managed Footer | `assets/js/frontend-footer.js` | Managed Footer module | 3.10.135 | Active |
| CSS-004 | CSS | Control Center UI | `assets/css/luxury.css` | WP Admin ALOOKHOR pages | 3.10.135 | Active |
| JS-005 | JavaScript | Control Center app | `assets/js/app.js` + modules | WP Admin ALOOKHOR pages | 3.10.135 | Active |
| CSS-005 | CSS | Managed Hero | `assets/css/frontend-hero.css` | `[alookhor_managed_hero]` / automatic Home replacement | 3.10.135 | Active |
| JS-006 | JavaScript | Managed Hero runtime | `assets/js/frontend-hero.js` | Four-slide replacement, controls and REST refresh | 3.10.135 | Active |
| CSS-006 | CSS | Managed Site Features | `assets/css/frontend-features.css` | `[alookhor_managed_features]` / automatic Home replacement | 3.10.135 | Active |
| JS-007 | JavaScript | Managed Site Features runtime | `assets/js/frontend-features.js` | Four-card replacement and REST refresh | 3.10.135 | Active |
...
| `plugin/alookhor-control-center/alookhor-control-center.php` | 425 | `538aecbe651b99169744590936b4b32a7cf70f4cb478aed5249b8658e74147ab` |
...
| `plugin/alookhor-control-center/assets/css/frontend-header-akx.css` | 975 | `b3765f316f63db9c0676ac5c85bbc51efd995bde2fbfbdf5761b0731e023752b` |
...
| `plugin/alookhor-control-center/assets/css/frontend-why-alookhor.css` | 4 | `eda33c3dc1e01ee5ced4a35ddbe4fbdcdbf9dc7cbe850e92fc483086be77bd09` |
...
| `plugin/alookhor-control-center/assets/js/app.js` | 325 | `2d5d3a60604cb0c4dd5207fa1f747ac3099adbe253ac16a7749e75a764f0e4d9` |
...
| `plugin/alookhor-control-center/assets/js/core/updateSystem.js` | 249 | `16fdcf77d0d1a965d702a3cb1557ccbd9fb96942e61c5fbfc1d6cc717805190f` |
...
| `plugin/alookhor-control-center/assets/js/modules/dashboard.js` | 173 | `1d9e617edae3f965b06acd91a956db0c0b18719a06cdf1ec9661b0ddf46cd2bf` |
...
| `plugin/alookhor-control-center/assets/js/modules/settings.js` | 780 | `264a13fe5b66031b2023911114ff5a1460a276f781b23995f6ef91af5986cd66` |
...
| `plugin/alookhor-control-center/config/site.json` | 323 | `147d8e7175aa8459ecf30c1f6d5ae94d6ff3499a9839ef56aa01c118c28a622f` |
...
| `plugin/alookhor-control-center/templates/admin-control-center.php` | 387 | `6c745ec63388219dee67a3f0c8941cc359323665e242a09240944d387c56390a` |
...
| `scripts/wordpress_release_test.py` | 395 | `60b045db79d24aa41874c96a982225474da09ff54580d9330f68764ce257a27a` |
...
define('ALOOKHOR_CC_VERSION', '3.10.135');
define('ALOOKHOR_CC_BUILD', '3.10.135');
...
/* v3.10.135 — thin continuous luminous frame around the main glass capsule. */
...
body #akx-header .akx-nav-capsule:hover:after{opacity:1;box-shadow:0 0 10px color-mix(in srgb,var(--akx-light-gold,#F5D76E) 40%,transparent),inset 0 0 7px color-mix(in srgb,var(--akx-gold,#D4AF37) 16%,transparent)}
...
/* v3.10.135 — luxury glass trust treatment inspired by the approved standards reference. */
...
import { initResponsive } from './core/responsive.js?v=3.10.135';
import { initUpdater, Updater } from './core/updateSystem.js?v=3.10.135';
import { Config } from './core/config.js?v=3.10.135';
import { dashboardModule } from './modules/dashboard.js?v=3.10.135';
import { inventoryModule } from './modules/inventory.js?v=3.10.135';
import { ordersModule } from './modules/orders.js?v=3.10.135';
import { usersModule } from './modules/users.js?v=3.10.135';
import { analyticsModule } from './modules/analytics.js?v=3.10.135';
import { settingsModule } from './modules/settings.js?v=3.10.135';
...
const runtimeVersion = String(runtimeConfig.version || '3.10.135');
...
export const Updater = {
  ...
  lastCheck: null,
  changelog: [
    { tag: 'WHY MOTION', title: 'v3.10.135 — چرا آلوخور شیشه‌ای و متحرک', desc: 'Glass، Shine، Hover، Reveal مرحله‌ای و شمارنده پویا اضافه شد.' },
    ...
    <div class="lux-header-inner">
      ...
      <div class="header-actions">
        <div class="version-badge" title="نسخه فعلی">
          ...
          <span id="headerVersion">v3.10.135</span>
  ...
  <div class="shell">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div style="padding:12px; background: linear-gradient(135deg, rgba(201,168,106,0.13), rgba(201,168,106,0.04)); border:1px solid var(--gold-border-strong); border-radius:16px">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-top:10px">
          <div style="background:rgba(255,255,255,0.04); border:1px solid var(--gold-border); border-radius:10px; padding:8px; text-align:center"><div style="font-size:11px; color:var(--text-faint)">نسخه</div><b id="versionBadgeText" style="font-family:monospace; font-size:12px; color:var(--text-primary)">v3.10.135</b></div>
    ...
    <main class="main">
      ...
      <div style="margin-top:18px; padding:14px 16px; display:flex; flex-wrap:wrap; gap:10px; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.02); border:1px solid var(--gold-border); border-radius:14px; font-size:12px; color:var(--text-muted)">
        <span>© 2026 ALOOKHOR — Control Center v3.10.135 • <span id="pageTitle" style="color:var(--gold-soft); font-weight:700">داشبورد</span> • معماری ماژولار حفظ شد</span>
        <span style="display:flex; gap:8px; align-items:center">
    ...
    <div class="modal-card">
      <div class="modal-head">
        <div style="display:flex; align-items:center; gap:12px">
          ...
          <div>
            <h3>Update Center</h3>
            <div style="font-size:12px; color:var(--text-muted); margin-top:2px" id="modalVersion">v3.10.135 — به‌روز</div>
          </div>
        </div>
