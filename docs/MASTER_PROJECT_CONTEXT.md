...
- **Current source target:** `3.10.49` — Luxury Burgundy/Gold image-accurate header + mega-menu glass (professional) prepared for test/publication; Production remains 3.10.18 until tagged deployment succeeds.
- **3.10.49 candidate package SHA-256:** `69c3b98d3d39c9636d3126cb48227e32792cd12edec0d039c352362b71251cfe` (rebuilt 2026-08-21 — luxury Burgundy/Gold image-accurate header + mega-menu glass (professional, image.png), superseding cef28f36 and 351e78e7 candidates)
