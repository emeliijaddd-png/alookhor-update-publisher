# 📦 سند جامع انتقال — پروژهٔ آلوخور (به‌روز: v3.10.222)
...
- **افزونه:** `plugin/alookhor-control-center/` — نسخهٔ فعلی **3.10.222** (زنده و تأییدشده — PDP کاملاً به موکاپ جدید مالک بازطراحی شده؛ بصری کامل = 3.10.212 + پولیش ۳.10.214/۲۱۶/۲۱۷ (تومان، مخفی بودن وزنِ خالی، تراز تعداد، ارقام فارسی)؛ ۲۱۳/۲۱۵ فقط CI)
...
| **222** | frontend-responsive-v2.css (آخرین لود) — باند ۷۶۸–۱۱۰۰ + overflow-x:clip + مهار table/img | **زنده و سبز کامل** |
