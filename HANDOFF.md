# 📦 سند جامع انتقال — پروژهٔ آلوخور (به‌روز: v3.10.220)
...
- **افزونه:** `plugin/alookhor-control-center/` — نسخهٔ فعلی **3.10.220** (زنده و تأییدشده — PDP کاملاً به موکاپ جدید مالک بازطراحی شده؛ بصری کامل = 3.10.212 + پولیش ۳.10.214/۲۱۶/۲۱۷ (تومان، مخفی بودن وزنِ خالی، تراز تعداد، ارقام فارسی)؛ ۲۱۳/۲۱۵ فقط CI)
...
| **220** | فاز ۱ سئو تکنیکال: اسکیمای Product واحد و غنی‌تر (حذف تکرار WC)، Organization/WebSite فقط اگر Yoast غایب، alt خودکار محصول، لاگ ۴۰۴، پروب blog_public/پیوند/ووکامرس/Yoast | **زنده و سبز کامل** |
